...
1. Download & install Anaconda for Python 3.7 [here](https://www.anaconda.com/distribution/)
...
```
git clone https://github.com/davidanastasiu/COEN-281-W20.git
```

Now you should have all the materials in a `COEN-281-W20` folder; to get the latest versions, just run:
